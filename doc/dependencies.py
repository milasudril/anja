...
<p>This chapter lists all external dependencies used within the Anja project. The items listed in <ref>libs</ref> are also needed to run Anja. On some distributions, library packages are split into a runtime package and a development package. In this case, only the runtime package is needed to run Anja, but the development package is needed to compile Anja.</p>
